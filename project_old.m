...
[inliers, outliers] = ransacPose(p2D_check, p3D_check,newK,3000,8,floor(length(p2D_check)*0.5));
% figure()
...
%%
G = compute_exterior(newK,[R T], p2D_best(modelPoints,:)',p3D_best(modelPoints,:)', MethodName.Posit);
% plotOnImage(checkImg,p2D_best(modelPoints,:), p3D_best(modelPoints,:), newK, G);
plotOnImage(checkImg,p2D_best(modelPoints,:), p3D_check, newK, G);
%%
index = [ 124, 78, 136, 162, 137, 151, 10, 12, 62, 40, 50, 159]; 
